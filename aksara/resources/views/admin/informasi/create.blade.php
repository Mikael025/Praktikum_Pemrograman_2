<x-layouts.admin>
    <div class="space-y-6">
        <h1 class="text-xl font-semibold text-gray-900 dark:text-white">Tambah Informasi</h1>
        <form method="POST" action="{{ route('admin.informasi.store') }}" class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow space-y-4">
