<x-layouts.admin>
    <div class="space-y-6">
        ...
        <div class="flex gap-2">
            @php($k = request('k'))
            <a href="{{ route('admin.informasi.index') }}" class="px-3 py-1 rounded {{ $k ? 'text-gray-500' : 'bg-blue-100 text-blue-800' }}">Semua</a>
            <a href="{{ route('admin.informasi.index', ['k' => 'penelitian']) }}" class="px-3 py-1 rounded {{ $k==='penelitian' ? 'bg-blue-100 text-blue-800' : 'text-gray-500' }}">Penelitian</a>
            <a href="{{ route('admin.informasi.index', ['k' => 'pengabdian']) }}" class="px-3 py-1 rounded {{ $k==='pengabdian' ? 'bg-blue-100 text-blue-800' : 'text-gray-500' }}">Pengabdian</a>
            <a href="{{ route('admin.informasi.index', ['k' => 'umum']) }}" class="px-3 py-1 rounded {{ $k==='umum' ? 'bg-blue-100 text-blue-800' : 'text-gray-500' }}">Umum</a>
        </div>
