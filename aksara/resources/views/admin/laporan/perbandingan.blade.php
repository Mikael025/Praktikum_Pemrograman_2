<x-layouts.admin>
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex justify-between items-center">
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">Perbandingan Data Kegiatan - Admin</h2>
                    <p class="mt-1 text-sm text-gray-600">Visualisasi data penelitian dan pengabdian semua dosen</p>
                </div>
                <a href="{{ route('admin.laporan.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700">
                    ← Kembali
                </a>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <canvas id="jenisKegiatanChart" height="120"></canvas>
                    </div>
                </div>

                <!-- Chart: Dosen Aktif per Tahun -->
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4">Dosen Aktif per Tahun</h3>
                        <canvas id="dosenAktifChart" height="120"></canvas>
                    </div>
                </div>
            </div>

            <!-- Top 5 Dosen Produktif -->
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4">Top 5 Dosen Paling Produktif</h3>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Pengabdian</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        {{ $dosen->penelitian_count }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        {{ $dosen->pengabdian_count }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                                            {{ $dosen->penelitian_count + $dosen->pengabdian_count }}
                                        </span>
                                    </td>
                                </tr>
                                @endforeach
    ...
    <script>
        ...
        const dosenAktifData = @json(array_values($dosenAktifPerTahun));
        ...
        // Chart 5: Dosen Aktif per Tahun
        new Chart(document.getElementById('dosenAktifChart'), {
            type: 'line',
            data: {
                labels: years,
                datasets: [{
