<x-layouts.dosen>
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Penelitian Saya</h1>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-50 dark:bg-gray-900">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase">Tim Peneliti</th>
    ...
    <script>
        function uploadDocument(penelitianId) {
            document.getElementById('uploadForm').action = `/dosen/penelitian/${penelitianId}/upload-document`;
